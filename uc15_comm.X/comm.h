...
#define UC15_UART (UART2)
#define UC15_UART_VEC (_UART_2_VECTOR)
#define UC15_RX_INT (INT_U2RX)
#define UC15_INT_VEC (INT_UART_2_VECTOR)

#define SERIAL_UART (UART1)
#define SERIAL_UART_VEC (_UART_1_VECTOR)
#define SERIAL_RX_INT (INT_U1RX)
#define SERIAL_INT_VEC (INT_UART_1_VECTOR)
